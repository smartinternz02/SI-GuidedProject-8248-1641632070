...
app = Flask(__name__)
model = pickle.load(open(r'C:\Users\SNEHA\Visarfr.pkl','rb'))
...
def predict():
    ...
    payload_scoring = {"input_data": [{"field": [['FULL_TIME_POSITION', 'PREVAILING_WAGE', 'YEAR','OCCUPATION']], "values": [input_features]}]}
    ...
    '''features_name = ['FULL_TIME_POSITION', 'PREVAILING_WAGE', 'YEAR','OCCUPATION']
